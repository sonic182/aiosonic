...
class MultipartFile:
    ...
    Args:
        file_path_or_obj (Union[str, IOBase]): The path to the file (str) or an opened file object (IOBase) to be included in multipart data.
...
class MultipartForm:
    ...
    .. code-block:: python
        ...
        async def upload_file():
            ...
            multipart_file = MultipartFile("path/to/your/image.png", filename="custom_name.png", content_type="image/png")
    ...
    def add_field(
        ...
        Args:
            ...
            value (Union[str, IOBase, MultipartFile]): The value of the field. Can be a string, a file-like object, or a MultipartFile instance.
            filename (Optional[str]): The name of the file, if the value is a file-like object or MultipartFile.
    ...
    async def _generate_chunks(self):
        ...
        for field in self.fields:
            ...
            if isinstance(field[1], (IOBase, MultipartFile)):
                ...
                file_obj = (
                    field[1].file_obj
                    if isinstance(field[1], MultipartFile)
                    else field[1]
                )
